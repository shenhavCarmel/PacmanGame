...
public class Apple extends Fruit {
	...
	public Apple(int currStage, int[][] maze, GameTimer leadTimer) {

		super(200,2,4,5, leadTimer);
	...
	// add all apples to the board according to the stage
	...
	// add an apple to the board in a random way
	private void add() {
